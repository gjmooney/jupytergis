...
/**
 * Color-ramp symbology for wind particles (speed → colorScale).
 */
export function WindParticleSymbology({
	...
	const [selectedRamp, setSelectedRamp] = useState<ColorRampName>(
		(windOptions.colorRamp as ColorRampName) ??
			DEFAULT_WIND_COLOR_OPTIONS.colorRamp,
	);
